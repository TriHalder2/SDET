...
public class AddNewCandidate {
    ...
    public void CandidateInformation() {
    	driver.findElement(By.id("addCandidate_firstName")).sendKeys("Trisha");
    	driver.findElement(By.id("addCandidate_lastName")).sendKeys("Halder");
    ...
    public void Verfication() {	
    	...
    	Name.sendKeys("Trisha Halder");
    	driver.findElement(By.id("btnSrch")).click();    	    	
    	String JobTitle1 = driver.findElement(By.linkText("Trisha Halder")).getText();
    	Assert.assertEquals(JobTitle1, "Trisha Halder"); 
    }
    @And("^Close windows.$")
